...
let life = 3, money = 0, combo = 0, tips = 0;
let currentCorrect;
...
submitBtn.addEventListener("click", ()=>{
  ...
  if(ans === currentCorrect) {
    ...
    money += reward;
    messageEl.textContent = `正解！+${reward} money`; comboEl.textContent=combo;
  } else {
...
tipBtn.addEventListener("click", ()=>{
  if(money>=100) { money-=100; tips++; moneyEl.textContent=money; messageEl.textContent="Tipを獲得しました";} 
